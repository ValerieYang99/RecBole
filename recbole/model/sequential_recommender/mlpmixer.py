...
class MLPMixer(SequentialRecommender):
    def __init__(self, config, dataset):
        ...
        self.channelMixer = PreNormResidual(self.hidden_size, FeedForward(self.hidden_size, expansion_factor, self.hidden_dropout_prob, chan_last))
